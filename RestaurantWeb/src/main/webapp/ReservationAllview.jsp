...
#reservationallview th {
  color: #168;
  background: #f0f6f9;
}
#reservationallview th, #reservationallview td {
  padding: 10px;
  border: 1px solid #ddd;
}
#reservationallview th:first-child, #reservationallview td:first-child {
  border-left: 0;
}
#reservationallview th:last-child, #reservationallview td:last-child {
  border-right: 0;
}
</style>
