...
public class MemberDaoImpl implements MemberDao {
	...
	public void update(Member member) throws Exception {
		jdbcTemplate.update("update member set pw=?, phone=? where id=?", member.getPw(), member.getPhone(),
				member.getId());
	...
	public Member findId(String name, String phone) throws Exception {
		Member member = jdbcTemplate.queryForObject("select * from member where name=? and phone=?",
	...
	public Member findPw(String id, String name, String phone) throws Exception {
		Member member = jdbcTemplate.queryForObject("select * from member where id=? and name=? and phone=?",
				new RowMapper<Member>() {
